...
c                    independently.
c
c$Id: imrm.for,v 1.5 2010/09/24 05:11:29 cal103 Exp $
c--
c  History:
...
c-----------------------------------------------------------------------
      d = pa1 - pa2
      if (d.gt.dpi/2d0) then
        pa2 = pa2 + dpi
      else if (d.lt.-dpi/2d0) then
        pa2 = pa2 - dpi
      endif
...
c
      if (ambig) rmi = rm0
      do i = 1, n
        ypl(i) = (pa(i) + rmi*lsq(i)) * 180d0/dpi
      enddo
