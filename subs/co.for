...
c
c    Manipulate a coordinate object - coReinit required:
...
c      coPrjSet(lu,proj)
c
c    Manipulate a coordinate object - coReinit not required:
c      coAltPrj(lu)
c      coSpcSet(lu,type,frame,iax,algo)
c
...
c
c $Id: co.for,v 1.29 2012/01/25 06:21:35 cal103 Exp $
c***********************************************************************
